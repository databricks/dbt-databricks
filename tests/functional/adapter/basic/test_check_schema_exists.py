...
class TestCheckSchemaExists:
    ...
    def test_check_schema_exists(self, project, setUp):
        ...
        with project.adapter.connection_named("__test"):
            ...
            assert exists is True, f"Expected schema '{test_schema}' to exist but check returned False"
            ...
            assert exists is False, f"Expected schema '{non_existent_schema}' to not exist but check returned True"
            ...
            assert exists is True, f"Expected default test schema '{project.test_schema}' to exist but check returned False"
