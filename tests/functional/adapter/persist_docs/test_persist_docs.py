...
class TestPersistDocsUC(BasePersistDocs):
    pass


@pytest.mark.skip_profile("databricks_uc_cluster", "databricks_uc_sql_endpoint")
class TestPersistDocsHMS(DatabricksPersistMixin, BasePersistDocs):
    pass


@pytest.mark.skip_profile("databricks_cluster")
class TestPersistDocsUCColumnMissing(BasePersistDocsColumnMissing):
    pass


@pytest.mark.skip_profile("databricks_cluster")
class TestPersistDocsUCCommentOnQuotedColumn(BasePersistDocsCommentOnQuotedColumn):
    pass
