...
class TestNotMatchedBySourceAndConditionThenDelete(IncrementalBase):
    ...
    def seeds(self):
        return {
            "not_matched_by_source_expected.csv": fixtures.not_matched_by_source_then_delete_expected,
        }
...
class TestNotMatchedBySourceAndConditionThenUpdate(IncrementalBase):
    ...
    def seeds(self):
        return {
            "not_matched_by_source_expected.csv": fixtures.not_matched_by_source_then_update_expected,
        }
