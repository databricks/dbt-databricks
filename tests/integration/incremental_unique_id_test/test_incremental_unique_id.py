...
class TestIncrementalUniqueKey(DBTIntegrationTest):
    ...
    def project_config(self):
        return {
            "config-version": 2,
            "models": {"+file_format": "delta", "+incremental_strategy": "merge"},
        }
    ...
    def test_scenario_correctness(self, expected_fields, test_case_fields):
        ...
        self.assertEqual(expected_fields.seed_count, test_case_fields.seed_count)
        # 2. test model(s) should build afresh
        self.assertEqual(expected_fields.model_count, test_case_fields.model_count)
        # 3. seeds should have intended row counts post update
        self.assertEqual(expected_fields.seed_rows, test_case_fields.seed_rows)
        # 4. incremental test model(s) should be updated
        self.assertEqual(
            expected_fields.inc_test_model_count, test_case_fields.inc_test_model_count
        )
        ...
        if expected_fields.opt_model_count and test_case_fields.opt_model_count:
            self.assertEqual(expected_fields.opt_model_count, test_case_fields.opt_model_count)
...
class TestNoIncrementalUniqueKey(TestIncrementalUniqueKey):
    ...
    def test__databricks_uc_sql_endpoint_no_unique_keys(self):
        self.test__databricks_sql_endpoint_no_unique_keys()
    ...
    def test__databricks_uc_cluster_no_unique_keys(self):
        self.test__databricks_cluster_no_unique_keys()
...
class TestIncrementalStrUniqueKey(TestIncrementalUniqueKey):
    ...
    @use_profile("databricks_uc_sql_endpoint")
    def test__databricks_uc_sql_endpoint_empty_str_unique_key(self):
        self.test__databricks_sql_endpoint_empty_str_unique_key()
    ...
    @use_profile("databricks_uc_cluster")
    def test__databricks_uc_cluster_empty_str_unique_key(self):
        self.test__databricks_cluster_empty_str_unique_key()
    ...
    @use_profile("databricks_uc_sql_endpoint")
    def test__databricks_uc_sql_endpoint_one_unique_key(self):
        self.test__databricks_sql_endpoint_one_unique_key()
    ...
    @use_profile("databricks_uc_cluster")
    def test__databricks_uc_cluster_one_unique_key(self):
        self.test__databricks_cluster_one_unique_key()
    ...
    @use_profile("databricks_uc_cluster")
    def test__databricks_uc_cluster_bad_unique_key(self):
        self.test__databricks_cluster_bad_unique_key()
...
class TestIncrementalListUniqueKey(TestIncrementalUniqueKey):
    ...
    @use_profile("databricks_uc_sql_endpoint")
    def test__databricks_uc_sql_endpoint_empty_unique_key_list(self):
        self.test__databricks_sql_endpoint_empty_unique_key_list()
    ...
    @use_profile("databricks_uc_cluster")
    def test__databricks_uc_cluster_empty_unique_key_list(self):
        self.test__databricks_cluster_empty_unique_key_list()
    ...
    @use_profile("databricks_uc_sql_endpoint")
    def test__databricks_uc_sql_endpoint_unary_unique_key_list(self):
        self.test__databricks_sql_endpoint_unary_unique_key_list()
    ...
    @use_profile("databricks_uc_cluster")
    def test__databricks_uc_cluster_unary_unique_key_list(self):
        self.test__databricks_cluster_unary_unique_key_list()
    ...
    @use_profile("databricks_uc_sql_endpoint")
    def test__databricks_uc_sql_endpoint_duplicated_unary_unique_key_list(self):
        self.test__databricks_sql_endpoint_duplicated_unary_unique_key_list()
    ...
    @use_profile("databricks_uc_cluster")
    def test__databricks_uc_cluster_duplicated_unary_unique_key_list(self):
        self.test__databricks_cluster_duplicated_unary_unique_key_list()
    ...
    @use_profile("databricks_uc_sql_endpoint")
    def test__databricks_uc_sql_endpoint_trinary_unique_key_list(self):
        self.test__databricks_sql_endpoint_trinary_unique_key_list()
    ...
    @use_profile("databricks_uc_cluster")
    def test__databricks_uc_cluster_trinary_unique_key_list(self):
        self.test__databricks_cluster_trinary_unique_key_list()
    ...
    @use_profile("databricks_uc_sql_endpoint")
    def test__databricks_uc_sql_endpoint_trinary_unique_key_list_no_update(self):
        self.test__databricks_sql_endpoint_trinary_unique_key_list_no_update()
    ...
    @use_profile("databricks_uc_cluster")
    def test__databricks_uc_cluster_trinary_unique_key_list_no_update(self):
        self.test__databricks_cluster_trinary_unique_key_list_no_update()
    ...
    @use_profile("databricks_uc_sql_endpoint")
    def test__databricks_uc_sql_endpoint_bad_unique_key_list(self):
        self.test__databricks_sql_endpoint_bad_unique_key_list()
    ...
    @use_profile("databricks_uc_cluster")
    def test__databricks_uc_cluster_bad_unique_key_list(self):
        self.test__databricks_cluster_bad_unique_key_list()
