...
- Fix `Constraint already exists` error when rebuilding a model with an unnamed primary/foreign key under `use_safer_relation_operations` ([#1600](https://github.com/databricks/dbt-databricks/pull/1600) resolves [#1091](https://github.com/databricks/dbt-databricks/issues/1091))
