...
- Fix performance issue associated with persist docs by turning off incremental catalog generation ([608](https://github.com/databricks/dbt-databricks/issues/608))
