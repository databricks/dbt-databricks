...
- Reorganize `docs/` into `docs/flow/` and `docs/guides/`, and sync materialization flow diagrams with the current macros (test-only, no runtime impact) ([#1627](https://github.com/databricks/dbt-databricks/pull/1627))
