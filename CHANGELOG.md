...
- Fix performance issue associated with persist docs by turning off incremental catalog generation ([615](https://github.com/databricks/dbt-databricks/pull/615))
